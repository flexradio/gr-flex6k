/**
 * @file flex_waveformlib_ptrdef.h $
 * @brief base interface for flex radio
 * @author nlong
 *
 * $Revision: LPI-LPD-Development_nlong/4 $
...
#ifndef FLEX_WAVEFORMLIB_FCNDEF
#define FLEX_WAVEFORMLIB_FCNDEF
// duplicate of waveform api, converted to function pointers for dlsym.
...
namespace flex
{
    class waveformlib_ptrdef
    {
    public: //names are public 
        /// @struct waveform_t
        ...
        protected: //methods are protected
